...
public class CustomImageView extends AppCompatImageView {
    ...
    private void initImagePositionAndSize() {
        ...
        float scaleFactor = Math.min(getWidth() / mBoundRectF.width() / 6, getHeight() / mBoundRectF.height() / 6);
...
//        mCurrentMatrix.postTranslate(getPivotX() - mBoundRectF.centerX(), getPivotY() - mBoundRectF.centerY());
        mCurrentMatrix.postTranslate(config.height - (mBoundRectF.width() + 30), config.width - (mBoundRectF.height() + 60));
